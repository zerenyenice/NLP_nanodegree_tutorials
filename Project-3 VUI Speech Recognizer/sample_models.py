...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    for i in range(recur_layers):
        x = SimpleRNN(units, activation='relu',
        return_sequences=True, implementation=2, name=f'rnn{i}')(x)
...
def final_model(input_dim, units, filters, kernel_size, conv_stride,
    conv_border_mode, dropout, output_dim=29):
    ...
    bidir_rnn = Bidirectional(SimpleRNN(units, activation='relu',
        return_sequences=True, implementation=2, name='rnn',dropout=dropout))(bn_cnn)
    
    bidir_rnn = BatchNormalization()(bidir_rnn)
    
    rnn2 = SimpleRNN(units, activation='relu',
        return_sequences=True, implementation=2, name='rnn2',dropout=dropout)(bidir_rnn)
